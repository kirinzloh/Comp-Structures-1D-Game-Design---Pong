...
module ball_5 (
  ...
  reg [3:0] M_hitcounter_d, M_hitcounter_q = 1'h0;
        ...
        if (M_counter_q >= M_ballspeed_q) begin
          if (playing == 1'h1) begin
            ...
            if (M_hitcounter_q == 1'h0) begin
              ...
              if (M_hitcounter_q == 2'h3) begin
                M_ballspeed_d = 23'h6acfc0;
              end else begin
                if (M_hitcounter_q == 3'h4) begin
                  M_ballspeed_d = 23'h5b8d80;
                end else begin
                  if (M_hitcounter_q == 3'h6) begin
                    M_ballspeed_d = 23'h4c4b40;
                  end else begin
                    if (M_hitcounter_q >= 4'h8) begin
